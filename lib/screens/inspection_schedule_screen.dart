            ...
            SingleChildScrollView(
              ...
              child: DataTable(
                ...
                columns: const [
                  ...
                  DataColumn(label: Text('통시', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w700))),
                  DataColumn(label: Text('공대', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w700))),
                ...
                rows: items.map((item) => DataRow(cells: [
                  ...
                  DataCell(Text(item.tongsi, style: const TextStyle(fontSize: 12))),
                  DataCell(Text(item.gongdae, style: const TextStyle(fontSize: 12))),
